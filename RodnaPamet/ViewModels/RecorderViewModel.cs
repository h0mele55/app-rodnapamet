...
namespace RodnaPamet.ViewModels
{
    public class RecorderViewModel : BaseViewModel
    {
        ...
        public RecorderViewModel(IAnimatable cont, CameraPreview cameraPreview) : base(cont)
        {
...
//            {
        ...
        async Task ExecuteRecordCommand()
        {
            ...
            camPreview.StartRecording.Execute(null);
            StartLabelTimer();
            IsRecording = true;
        }
        ...
        async Task ExecuteStopCommand()
        {
            ...
            camPreview.StopRecording.Execute(null);
            StopLabelTimer();
            question = 0;
